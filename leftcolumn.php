...
<div id="isa_leftcolumn">
	...
	<a href="speechboard_base.php?lang=<? echo $language; ?>&amp;ttse=<? echo $ttse; ?>"><img src="./images/home/menu_speechboardbase.png" /></a>
	<a href="speechboard.php?lang=<? echo $language; ?>&amp;ttse=<? echo $ttse; ?>"><img src="./images/home/menu_speechboard.png" /></a>
	<a href="wordboard.php?lang=<? echo $language; ?>&amp;ttse=<? echo $ttse; ?>"><img src="./images/home/menu_wordboard.png" /></a>
	<a href="imageboard.php?lang=<? echo $language; ?>&amp;ttse=<? echo $ttse; ?>"><img src="./images/home/menu_imageboard.png" /></a>
