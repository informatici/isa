...
<div id="isa_leftcolumn">
    ...
    <a href="?lang=it&amp;ttse=<?php echo $ttse; ?>" <?php echo $disable_it;?>><img src="./images/flag_it.png" /></a>
    <a href="?lang=en&amp;ttse=<?php echo $ttse; ?>" <?php echo $disable_en;?>><img src="./images/flag_en.png" /></a>
